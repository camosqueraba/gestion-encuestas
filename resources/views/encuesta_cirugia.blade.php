...
<head>
	...
	<link rel="canonical" href="http://www.perfectbody.com.co/">
...
<body class="home page-template page-template-template-default-without-breadcrumbs page-template-template-default-without-breadcrumbs-php page page-id-3756 wpb-js-composer js-comp-ver-6.1 vc_responsive">
		...
		<div class="header-container ">
              ...
              /*
						...
						<li id="menu-item-3995" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent opcion-desplegable current_page_ancestor .menu-item-has-children menu-item-3995">
							...
							<ul class="sub-menu">
								...
								<ul class="sub-menu">
									<li id="menu-item-4361" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4361"><a href="https://drive.google.com/drive/folders/1k4Fs7dxleOv89UiUd29qqSjPYUMo-2O3?usp=sharing">Actas Copasst</a></li>
									<li id="menu-item-4363" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4363"><a href="https://drive.google.com/drive/folders/1pEoKvIP8MGGIm8WfdSxF8bTAIg0kQnOE?usp=sharing">Balance general y Estado de resultados</a></li>
								</ul>
							</li>
            ...
            -->
				...
				<div class="mobile-menu-container clearfix">
					...
					<nav class="mobile-menu collapsible-mobile-submenus">
						<ul id="menu-main-menu-1" class="menu">
							<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-3756 current_page_item menu-item-3965">
								<a href="http://www.perfectbody.com.co/" aria-current="page">
									INICIO
								</a>
							</li>
							...
							<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-3995">
								...
								<ul class="sub-menu">
									<li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-has-children menu-item-4362"><a href="http://www.perfectbody.com.co/#" aria-current="page">Marco legal</a>
										<ul class="sub-menu">
											<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4361"><a href="https://drive.google.com/drive/folders/1k4Fs7dxleOv89UiUd29qqSjPYUMo-2O3?usp=sharing">Actas Copasst</a></li>
              ...
              <!--/*
							...
							<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-4001">
								<a href="http://www.perfectbody.com.co/informacion-paciente-y-familia/">INFORMACIÓN PACIENTE Y FAMILIA</a>
								<a href="http://www.perfectbody.com.co/#" class="template-arrow-menu"></a>
								<ul class="sub-menu">
									<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4261"><a href="http://www.perfectbody.com.co/atencion-al-usuario/">Atención al usuario</a></li>
								</ul>
							</li>
          ...
          <section class="row">
            <div class="col-md-8">
              <div class="form-group">
                ...
                <input type="text" class="form-control input-datos" id="nombreCompleto" maxlength="128" placeholder="Nombre del Paciente" required>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="idIdentificacion">Identificación:*</label>
                <input type="number" id="identificacion" class="form-control input-datos" placeholder="Numero de Identificación" maxlength="15" required/>
              </div>
            </div>
          </section>
          ...
          <section class="row">
            <div class="col-md-8">
              <div class="form-group">
                ...
                <input type="email" class="form-control input-datos" id="email" maxlength="128" placeholder="Correo Electronico" required>
              </div>
            </div>
            <div class="col-md-4">
              <label for="telefono">Teléfono/Celular:*</label>
              <input type="text" class="form-control input-datos" id="telefono" placeholder="Telefono/Celular" maxlength="30" required/>
            </div>
          ...
          <section class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="date" class="form-control input-datos" id="fechaEncuesta" required>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="number" class="form-control input-datos" id="numeroHabitacion" required>
              </div>
            </div>
            <!--
            <div class="col-md-4">
